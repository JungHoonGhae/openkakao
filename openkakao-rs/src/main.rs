...
mod tests {
    ...
    fn profile_accepts_local_flag() {
        let cli = Cli::try_parse_from(["openkakao-rs", "profile", "103040201", "--local"])
    ...
    fn collect_hint_chat_ids_prefers_user_specific_chat_hints() {
        let hints = vec![
            ProfileCacheHint {
                ...
                user_ids: vec![103040201],
                chat_id: Some(383501960735974),
            ...
            ProfileCacheHint {
                ...
                kind: "friend".into(),
                request_key: String::new(),
                user_ids: vec![32262572],
                chat_id: Some(382367313744175),
        ...
        assert_eq!(
            collect_hint_chat_ids(&hints, 103040201),
            vec![383501960735974]
        );
        assert_eq!(
            collect_hint_chat_ids(&hints, 32262572),
            vec![382367313744175]
        );
    ...
    fn syncmainpf_candidates_include_getmem_token_fields() {
        ...
        let candidate = build_syncmainpf_candidate(&snapshot, &[], 103040201)
