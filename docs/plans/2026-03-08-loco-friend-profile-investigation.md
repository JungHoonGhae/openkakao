...
- `probe SYNCMAINPF --body '{"ct":"me","pfid":100000001}' --json` reaches the method and returns `-203`.
...
- For `Alice` (`user_id=100000003`, `account_id=200000002`) the generated candidates were:
  - `ct=d,pfid=100000003,chatId=900000000000003,accessPermit=...`
  - `ct=p,pfid=100000003,chatId=900000000000003,accessPermit=...`
  - `ct=d,pfid=200000002,chatId=900000000000003,accessPermit=...`
  - `ct=p,pfid=200000002,chatId=900000000000003,accessPermit=...`
...
- This reuses one LOCO session and probes all generated `SYNCMAINPF` candidates plus:
  ...
  - optional `r=n`
  - optional `r=r`
- For `Alice` (`user_id=100000003`) this produced:
  - `candidate_count=4`
  - `probe_count=64`
  - all `body_status=-203`
