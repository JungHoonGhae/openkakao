...
```bash
openkakao-rs local-chats [OPTIONS]
```
...
```bash
openkakao-rs local-read <chat_id> [OPTIONS]
```
...
openkakao-rs local-read 900000000000001

# Read messages since a date
openkakao-rs local-read 900000000000001 --since 2025-01-01

# JSON output
openkakao-rs local-read 900000000000001 --json
```
...
```bash
openkakao-rs local-search <query> [OPTIONS]
```
...
```bash
openkakao-rs local-search "배포"
openkakao-rs local-search "meeting" --json
```
...
openkakao-rs local-schema --json
```
