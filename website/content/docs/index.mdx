...
| | |
|---|---|
| [**Quick Start**](/docs/quickstart) — Get up and running in 2 minutes | [**CLI Reference**](/docs/cli/overview) — Full command reference |
| [**LOCO Protocol**](/docs/protocol/overview) — How the binary protocol works | [**Automation**](/docs/guides/automation) — Build automations with Unix tools |
