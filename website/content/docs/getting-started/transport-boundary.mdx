...
- profile, friends, settings, and other account-adjacent reads
...
| `chats`, `read` | REST only when cache is enough | limited by what the desktop app recently opened |
| `loco-chats`, `loco-read` | LOCO | authoritative chat and message access |
